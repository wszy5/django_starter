...
def swim(request):
    ...
    a = T[T.index('05:45'):T.index('06:30')].count('')
    b = T[T.index('06:30'):T.index('07:15')].count('')
    c = T[T.index('07:15'):T.index('08:00')].count('')
    d = T[T.index('08:00'):T.index('08:45')].count('')
    e = T[T.index('08:45'):T.index('09:30')].count('')
    f = T[T.index('09:30'):T.index('06:30')].count('')
    g = T[T.index('05:45'):T.index('10:15')].count('')
    h = T[T.index('10:15'):T.index('11:00')].count('')
    i = T[T.index('11:00'):T.index('11:45')].count('')
    j = T[T.index('11:45'):T.index('12:30')].count('')
    k = T[T.index('12:30'):T.index('13:15')].count('')
    l = T[T.index('13:15'):T.index('14:00')].count('')
    m = T[T.index('14:00'):T.index('14:45')].count('')
    n = T[T.index('14:45'):T.index('15:30')].count('')
    o = T[T.index('15:30'):T.index('16:15')].count('')
    p = T[T.index('16:15'):T.index('17:00')].count('')
    r = T[T.index('17:00'):T.index('17:45')].count('')
    s = T[T.index('17:45'):T.index('18:30')].count('')
    t = T[T.index('18:30'):T.index('19:15')].count('')
    u = T[T.index('19:15'):T.index('20:00')].count('')
    w = T[T.index('20:00'):T.index('20:45')].count('')
    x = T[T.index('20:45'):T.index('21:30')].count('')
    p = r
